...
export default function Hero() {
  ...
  const fallbackHeroImage = '/hero/10_sm.jpg'
  const items = slides ?? []
  ...
  return (
    <section id="hero" className="relative min-h-[100svh] overflow-hidden md:min-h-[100dvh]">
      <img
      ...
      <div className="absolute inset-0 z-10 flex items-start px-4 pb-[clamp(1rem,3vh,1.25rem)] pt-[clamp(6.2rem,10vh,7rem)] text-white sm:items-start sm:px-6 sm:pb-12 sm:pt-[9.9rem] lg:items-center lg:px-10 lg:pb-14 lg:pt-0">
        <div className="w-full">
          <AnimatePresence mode="wait" initial={false}>
            <motion.div
              key={`content-${activeIndex}`}
              className="hero-content flex max-w-[18rem] flex-col items-start text-left sm:max-w-[22rem] md:max-w-[26rem] lg:mt-32 lg:max-w-[33rem]"
            ...
            >
              <h1
                className="hero-title mb-[clamp(0.55rem,1.4vh,1rem)] font-heading text-[clamp(2.05rem,10vw,2.72rem)] leading-[0.84] tracking-[-0.05em] text-[#f9f3eb] sm:mb-5 sm:text-[3.1rem] md:text-[3.9rem] lg:text-[4.9rem]"
              ...
              <div className="hero-title-underline-mobile mb-[clamp(0.7rem,1.8vh,1.15rem)] h-px w-10 bg-[#c39a59] sm:hidden" />
              <div className="hero-title-underline hidden h-px w-10 bg-[#c39a59] sm:mb-6 sm:block sm:w-16 lg:w-20" />

              <p className="hidden max-w-[15rem] font-editorial text-[0.88rem] leading-5 text-[#f3ebe0]/88 text-balance sm:mt-0 sm:block sm:max-w-[21rem] sm:text-[1.35rem] sm:leading-9 md:max-w-[24rem] md:text-[1.42rem] lg:max-w-[28rem] lg:text-[1.55rem] lg:leading-10">
                {luxurySubtitle}
              </p>

              <div className="hero-actions mt-0 flex w-full max-w-[15.6rem] flex-col items-stretch gap-2 sm:mt-8 sm:max-w-[22rem] md:max-w-[24rem] lg:mt-10 lg:max-w-none lg:flex-row lg:items-center lg:gap-4">
                <div className="hero-buttons flex w-full flex-col items-stretch gap-2 lg:flex-row lg:items-center lg:gap-4">
                  <a
                    href="#portfolio"
                    className="inline-flex min-w-0 items-center justify-center gap-2 rounded-md bg-[#d2aa67] px-3 py-2 font-ui text-[0.68rem] font-semibold uppercase tracking-[0.12em] text-[#26180f] shadow-[0_16px_32px_rgba(164,123,58,0.24)] transition-colors hover:bg-[#debc82] sm:px-6 sm:py-3.5 sm:text-sm lg:min-w-[14.5rem] lg:py-4"
                  >
                    View Portfolio
                  ...
                  <a
                    href="#contact"
                    className="inline-flex min-w-0 items-center justify-center rounded-md border border-[#9f7845] bg-[#1a110c]/34 px-3 py-2 font-ui text-[0.68rem] font-semibold uppercase tracking-[0.12em] text-[#f7eddc] backdrop-blur-sm transition-colors hover:bg-[#24160d]/42 sm:px-6 sm:py-3.5 sm:text-sm lg:min-w-[14.5rem] lg:py-4"
                  >
              ...
              <div className="hero-metrics mt-0 grid w-full max-w-[18rem] grid-cols-1 gap-x-4 gap-y-3 text-[#efdfc6] sm:max-w-[22rem] sm:mt-8 sm:grid-cols-1 md:max-w-[24rem] lg:mt-10 lg:max-w-none lg:grid-cols-[auto_1px_auto_1px_auto] lg:items-start lg:gap-5">
                ...
                <div className="flex min-w-0 items-center gap-2 sm:items-start sm:gap-3 lg:hidden">
                ...
                <div className="col-span-full mt-1.5 h-px w-full max-w-[7rem] bg-[linear-gradient(90deg,rgba(195,154,89,0.88)_0%,rgba(195,154,89,0.42)_70%,rgba(195,154,89,0.08)_100%)] sm:hidden" />
                <div className="hidden h-10 w-px self-center bg-[#89663d]/55 lg:block" />
                <div className="hidden min-w-0 items-center gap-2 sm:items-start sm:gap-3 lg:flex">
